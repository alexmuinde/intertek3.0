...
exports.getNoticeOfApparentDiscrepancyReport = async (request, response, next) => {
	try {
...
exports.checkNoticeOfApparentDiscrepancyReportOwnership = async (request, response, next) => {
	try {
		...
		if (documentId) {
			const existingReport = await NoticeOfApparentDiscrepancy.findById(documentId);
