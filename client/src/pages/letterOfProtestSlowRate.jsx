          ...
          if (data.success !== false) {
            ...
            setFormData({
              ...
              dateOfReport: actualReport.dateOfReport
                ...
                : "",
              commencedAtDates: actualReport.commencedAtDates
                ? actualReport.commencedAtDates.map((d) => (d ? d.split("T") : ""))
                : [""],
              completedAtDates: actualReport.completedAtDates
                ? actualReport.completedAtDates.map((d) => (d ? d.split("T") : ""))
                : [""],
            });
          } else {
